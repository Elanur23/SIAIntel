...
const OG_IMAGE =
  'https://images.unsplash.com/photo-1677447337457-6e6e64e824c2?q=80&w=1200&h=630&fit=crop'
...
export async function generateMetadata({
  ...
  const currentUrl = `${baseUrl}/${routeLang}/ai`
  ...
  return {
    ...
    alternates: {
      ...
      languages: buildLanguageAlternates('/ai', { baseUrl }),
    },
    openGraph: {
      title: t.title,
      description: t.desc,
...
export default function AiLayout({
  ...
  const lang = toDictionaryLocale(routeLang)
  const t = categorySeo[lang] || categorySeo.en
  const pageUrl = `${baseUrl}/${routeLang}/ai`

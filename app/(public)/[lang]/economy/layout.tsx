...
const OG_IMAGE =
  'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?q=80&w=1200&h=630&fit=crop'
...
export async function generateMetadata({
  ...
  const currentUrl = `${baseUrl}/${routeLang}/economy`
  ...
  return {
    ...
    alternates: {
      ...
      languages: buildLanguageAlternates('/economy', { baseUrl }),
    },
    openGraph: {
      title: t.title,
      description: t.desc,
...
export default function EconomyLayout({
  ...
  const lang = toDictionaryLocale(routeLang)
  const t = categorySeo[lang] || categorySeo.en
  const pageUrl = `${baseUrl}/${routeLang}/economy`

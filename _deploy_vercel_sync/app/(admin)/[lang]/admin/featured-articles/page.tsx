...
export default function LocalizedFeaturedArticlesPage() {
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <select
              ...
              className="px-4 py-2 bg-black/40 border border-white/10 rounded-xl text-white text-sm"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-xl font-bold uppercase tracking-wider text-sm transition-colors"
            >
        ...
        {showForm && (
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 mb-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl text-white focus:border-blue-500 outline-none"
                    required
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl text-white focus:border-blue-500 outline-none"
                    placeholder="bitcoin-analysis-2026"
                    required
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl text-white focus:border-blue-500 outline-none h-24"
                    required
                  />
                </div>
                <div className="md:col-span-2">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        category: e.target.value as 'CRYPTO' | 'AI' | 'STOCKS' | 'MACRO' | 'TECH',
                      })
                    }
                    className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl text-white focus:border-blue-500 outline-none"
                  >
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-blue-600 hover:bg-blue-700 rounded-xl font-black uppercase tracking-wider transition-colors"
              >
                <Save size={20} />
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            <div className="text-center py-12 text-slate-400">
              No featured articles yet. Click "Add Featured Article" to create one.
            </div>
          ) : (
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          <span className="px-3 py-1 bg-blue-600 rounded-full text-xs font-black uppercase">
                            {article.category}
                          </span>
                          <span className="px-3 py-1 bg-emerald-600 rounded-full text-xs font-black uppercase flex items-center gap-1">
                            <Star size={12} /> Priority {article.featuredPriority}
                          </span>
                        </div>

...
const SEO_CONTENT: Record<string, { title: string, desc: string }> = {
  en: { title: 'Privacy Protocol | SIA Intelligence', desc: 'Data protection and privacy standards for the SIA terminal network.' },
  tr: { title: 'Gizlilik Protokolü | SIA İstihbarat', desc: 'SIA terminal ağı için veri koruma ve gizlilik standartları.' },
};
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `${baseUrl}/${lang}/privacy-policy` },
      ...
      <div className="container mx-auto px-4 lg:px-10 py-12 md:py-20 relative z-10">
        ...
        <header className="space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div className="text-white/20 text-[9px] font-mono tracking-widest uppercase italic">{getT(lang)('legal.privacy_version')}</div>
          </div>
          ...
          <h1 className="text-5xl md:text-8xl font-black text-white uppercase italic tracking-tighter leading-[0.8] block">
            {getT(lang)('legal.privacy_title')}
              ...
              <div className="p-6 bg-white/[0.02] border border-white/10 rounded-2xl w-fit flex items-center gap-4">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40">Encryption_Standard: AES-256</span>
              </div>
            </header>
            ...
            <div className="prose prose-invert prose-xl max-w-none text-slate-400 leading-relaxed space-y-10 font-light italic border-l-2 border-white/5 pl-10">
              <p>
                At <strong>SIA Intelligence</strong>, accessible from siaintel.com, our primary priority is the absolute privacy of our institutional and retail nodes.
                This document outlines the telemetry data collected and how it is encrypted within the SIA neural matrix.
              </p>
              ...
              <p>
                SIA Intelligence follows a standard procedure of utilizing secure log files. These files log visitors when they interact with our terminal nodes.
                Information includes IP addresses, browser types, and timestamped activity logs for security auditing.
              </p>
              ...
              <p>
                Like any advanced intelligence platform, we use 'cookies' to optimize terminal performance. These cookies store preference data
                to ensure your language nodes and display settings remain consistent across sessions.
              </p>
              ...
              <p>
                Under GDPR and CCPA, users hold the right to request full data deletion. SIA Intelligence maintains no persistent personal identification
                profiles beyond what is necessary for encrypted session stability.
              </p>
            </div>
            ...
            <div className="p-10 rounded-[3rem] bg-white/[0.02] border border-white/5 space-y-6">
               ...
               <p className="text-sm text-slate-500 leading-relaxed italic">
                  By accessing the SIA Terminal, you acknowledge and agree to the secure data processing protocols outlined above.
                  Intelligence transmission is protected by sovereign encryption nodes.
               </p>
            </div>
          </article>
          ...
          <aside className="lg:col-span-4 space-y-8">
            <div className="p-10 rounded-[3rem] bg-[#0A0A0C] border border-white/10 space-y-8 shadow-2xl backdrop-blur-xl">
               <h3 className="text-xs font-black uppercase tracking-[0.3em] text-blue-400">Node_Verification</h3>
            ...
            <div className="p-10 rounded-[3rem] bg-gradient-to-br from-blue-600/10 to-transparent border border-blue-500/20">
               <p className="text-xs text-slate-400 leading-relaxed italic">
                  Questions regarding data sovereignty can be directed to the SIA Security Node at security@siaintel.com
               </p>
            </div>
          </aside>
        </div>

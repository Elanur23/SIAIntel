...
/**
 * Regional content variant for a single language/region
 */
...
/**
 * Complete regional news output with all language variants
 * This is the final output format for the SIA News system
 */
...
// ============================================================================
// INTELLIGENCE & RECOMMENDATION TYPES (NEW)
// ============================================================================

export type StrategicTone = 'sakin' | 'agresif' | 'resmi' | 'ultra-agresif' | 'spekülatif' | 'insider'

/**
 * SIA Smart Recommendation Engine Output
 * Determines the optimal tone for publishing to maximize CTR and authority
 */
export interface IntelligenceRecommendation {
  recommendedTone: StrategicTone
  logic: string // Analytical reasoning for the tone
  ctrPotential: number // 0-100 prediction
  isGoldSignal: boolean // High-impact trigger
  impactKeywords: string[] // Key terms driving the score
}

/**
 * Master Data Packet for Enhanced Content
 * High-fidelity quantitative data for professional reporting
 */
export interface MasterDataPacket {
  supplyShockRatio?: number // E.g., 12x production rate
  maginotLineLevel?: number // Critical support/resistance
  institutionalFlows: {
    source: string // E.g., BlackRock
    amount: number // E.g., in Billions
  }[]
  correlationShift: {
...
/**
 * Final Published Intelligence Report
 * The ultimate data structure for SIA global delivery
 */

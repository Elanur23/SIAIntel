...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || process.env.NEXT_PUBLIC_BASE_URL || 'https://siaintel.com'
...
export function buildArticleSeoPackage(params: {
  ...
  const articleData: NewsArticleData = {
    ...
    sources: [{ name: 'SIA SENTINEL', url: SITE_URL, type: 'news_wire', accessDate: getCurrentISOTimestamp() }],

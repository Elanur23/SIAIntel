...
const expertsSeo: Record<string, { title: string; description: string; keywords: string[] }> = {
  en: {
    ...
    description:
      'Meet our elite council of analysts providing institutional-grade intelligence across crypto, macro, tech, and global markets.',
    keywords: [
      'expert analysts',
  ...
  tr: {
    ...
    description:
      'Kripto, makro, teknoloji ve küresel piyasalarda kurumsal düzeyde istihbarat sunan seçkin analist konseyimizle tanışın.',
    keywords: [
      'uzman analistler',
      'finansal istihbarat ekibi',
      'beşler konseyi',
      'piyasa uzmanları',
    ],
  },
...
export async function generateMetadata({
  ...
  const t = expertsSeo[contentLang] ?? expertsSeo.en
  const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://siaintel.com'
  const currentUrl = `${baseUrl}/${routeLang}/experts`
  ...
  return {
    ...
    alternates: {
      ...
      languages: buildLanguageAlternates('/experts', { baseUrl }),
    },
    ...
    <div className="text-white selection:bg-blue-600 relative font-sans">
      ...
      <div className="container mx-auto px-4 lg:px-10 py-12 md:py-20 relative z-10">
        ...
        <nav className="flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.3em] text-white/20 mb-16">
          <Link href={`/${routeLang}`} className="hover:text-blue-500 transition-colors uppercase">
            Terminal
          </Link>
          ...
          <div className="lg:col-span-4 hidden lg:flex justify-end pb-4">
            <div className="flex items-center gap-6">
              <div className="text-right">
                ...
                <div className="text-[10px] text-slate-600 uppercase font-black tracking-[0.2em]">
                  ELITE_NODES
                </div>
              </div>
        ...
        <section className="bg-gradient-to-br from-blue-600/5 to-transparent rounded-[4rem] p-12 md:p-24 border border-blue-500/20 text-center relative overflow-hidden group shadow-2xl">
          ...
          <ShieldCheck
            size={80}
            className="text-emerald-500 mx-auto mb-10 animate-pulse drop-shadow-[0_0_15px_rgba(16,185,129,0.3)]"
          />
